...
model {
 ...
 x2 ~ normal(0,gamma);
  ...
  for (m in 1:M_regions){
    ...
    x4[m] ~ normal(0,gamma);
    x5[m] ~ normal(0,gamma);
    y1[m] ~ normal(x1[m],gamma);
    y2[m] ~ normal(x2[m],gamma);
    y3[m] ~ normal(x3[m],gamma);
    y4[m] ~ normal(x4[m],gamma);
    y5[m] ~ normal(x5[m],gamma);
    z1[m] ~ normal(y1[m],gamma);
    z2[m] ~ normal(y2[m],gamma);
    z3[m] ~ normal(y3[m],gamma);
    z4[m] ~ normal(y4[m],gamma);
    z5[m] ~ normal(y5[m],gamma);
